...
//sum purchase for each customer
bys user_id: egen total=sum(purchase)
//calculate expense proportion in different category
replace all_purchase=all_purchase/total
...
//marital status; gender: no obvious distinction
...
//age; city; stay_years: no obvious distinction
gen frequency = 1
