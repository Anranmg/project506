...
#Almost all are in the right cluster except age in group '26-35'
...
#From dendograms, 3 types of occupation form the left cluster. The other 18 types form the right cluster. Uneven. 

########################################################################################################
#Using percentage
#Using first 100 data points(scatter plot)
...
plt.figure(figsize=(10, 7))  
plt.scatter(sum_data[:,0], sum_data[:,1], c=cluster.labels_, cmap='rainbow') #scatter plot of test set 100
plt.scatter(sum_data_whole[:,0], sum_data_whole[:,1], c=cluster.labels_, cmap='rainbow') #scatter plot of whole data set
